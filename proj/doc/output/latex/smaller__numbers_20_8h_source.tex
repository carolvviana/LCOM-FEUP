\hypertarget{smaller__numbers_20_8h_source}{}\doxysection{0.h}
\label{smaller__numbers_20_8h_source}\index{C:/MINIX-\/LCOM/MINIX-\/LCOM/shared/g3/proj/src/sprites/smaller\_numbers/0.h@{C:/MINIX-\/LCOM/MINIX-\/LCOM/shared/g3/proj/src/sprites/smaller\_numbers/0.h}}
\mbox{\hyperlink{smaller__numbers_20_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
\DoxyCodeLine{1 \textcolor{comment}{/* XPM */}}
\DoxyCodeLine{2 \textcolor{preprocessor}{\#include <lcom/lcf.h>}}
\DoxyCodeLine{3 \textcolor{preprocessor}{\#include <lcom/xpm.h>}}
\DoxyCodeLine{4 }
\DoxyCodeLine{5 \textcolor{keyword}{static} xpm\_row\_t \textcolor{keyword}{const} SMALLER\_ZERO\_SPRITE[] = \{}
\DoxyCodeLine{6 \textcolor{stringliteral}{"{}40 50 2 1"{}},}
\DoxyCodeLine{7 \textcolor{stringliteral}{"{}   c None"{}},}
\DoxyCodeLine{8 \textcolor{stringliteral}{"{}.  c \#FFFFFF"{}},}
